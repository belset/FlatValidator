...
public class ExpressionTests
{
    ...
    public void _01_Base_Valued()
    {
        ...
        Assert.True(expression.GetMemberPath() == nameof(BaseModel.Id));
    }
    ...
    public void _02_Base_Referenced()
    {
        ...
        Assert.True(expression.GetMemberPath() == nameof(BaseModel.FullName));
    }
    ...
    public void _03_Base_Struct()
    {
        ...
        Assert.True(expression.GetMemberPath() == nameof(BaseModel.Date));
    }
    ...
    public void _04_Nested_Valued_via_Property()
    {
        ...
        Assert.True(expression.GetMemberPath() == $"{nameof(BaseModel.Nested)}.{nameof(NestedModel.Id)}");
    }
    ...
    public void _05_Nested_References_via_Property()
    {
        ...
        Assert.True(expression.GetMemberPath() == $"{nameof(BaseModel.Nested)}.{nameof(NestedModel.Name)}");
    }
    ...
    public void _06_Nested_Struct_via_Property()
    {
        ...
        Assert.True(expression.GetMemberPath() == $"{nameof(BaseModel.Nested)}.{nameof(NestedModel.Date)}");
    }
    ...
    public void _07_Nested_Valued_via_Method()
    {
        ...
        Assert.True(expression.GetMemberPath() == $"{nameof(BaseModel.GetNested)}.{nameof(NestedModel.Id)}");
    }
    ...
    public void _08_Nested_Referenced_via_Method()
    {
        ...
        Assert.True(expression.GetMemberPath() == $"{nameof(BaseModel.GetNested)}.{nameof(NestedModel.Name)}");
    }
    ...
    public void _09_Nested_Struct_via_Method()
    {
        ...
        Assert.True(expression.GetMemberPath() == $"{nameof(BaseModel.GetNested)}.{nameof(NestedModel.Date)}");
    }
    ...
    public void _10_Base_Array_IntIndexer()
    {
        ...
        Assert.True(expression.GetMemberPath() == "Ints[0]");
    }
    ...
    public void _11_Base_Array_Length()
    {
        ...
        var ret = expression.GetMemberPath();
        Assert.True(expression.GetMemberPath() == "Ints.Length");
    }
    ...
    public void _12_Base_Dict_StringIndexer()
    {
        ...
        Assert.True(expression.GetMemberPath() == "get_Item");
    }
}
