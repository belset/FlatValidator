...
namespace System.Validation1;

public static class ValidationFuncs
{
    #region ArgumentNullException if argument is Null // https://habr.com/ru/company/ruvds/blog/590689/
    public static T ThrowIfNull<T>([NotNull] this T? value, [CallerArgumentExpression("value")] string argName = "") where T : class =>
        value is null ? throw new ArgumentNullException(argName) : value;
    #endregion

    //#region Is argument Null or Not
    
    //[MethodImpl(MethodImplOptions.AggressiveInlining)]
    //public static bool IsNull<T>(this T? value) => value is null;

    //[MethodImpl(MethodImplOptions.AggressiveInlining)]
    //public static bool NotNull<T>(this T? value) => value is not null;
    ...
    #region Return Empty string if Null
